        ...
        <form className={styles.formContainer}>
            <div className='flex h-full w-full flex-col items-center'>
                <select className={styles.select} >
                    ...
                    <option className={styles.options} value='LINK'>LINK</option>
                    <option className={styles.options} value='DAI'>DAI</option>
                </select>
                ...
                <input placeholder='Amount...' className={styles.inputAmount}/>

                <button className={styles.noticeCTA}>Send</button>
            </div>
        </form>
    )
}
